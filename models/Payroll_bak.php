...
class Payroll extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tg_all', 'grand_total_salary', 't_msker', 'i_um', 'i_tidak_tetap', 'cicilan_kasbon', 'pot_safety', 'pengurangan', 'penambahan', 'pot_bpjs_kes'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tg_all' => 'Tg All',
            'grand_total_salary' => 'Grand Total',
            'payroll_name' => 'Payroll Name',            
            't_msker' => 'T Msker',
            'i_um' => 'I Um',
